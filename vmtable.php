		...
		<table class="table table-hover">
                ...
                if($noLogin == true) {
                    ...
                    echo '<tr>';
                        ...
                        echo '<td><img src="img/lxc.png" style="padding-right:5px;" />LXC</td>';
					 	...
					 	echo '<td><a href="manage?id='.escape($data[$i]->hb_account_id).'&virt=lxc" class="btn btn-sm btn-info">Manage</a></td>';
					echo '</tr>';
			...
			for($i = 0; $i < count($data); $i++) {
                ...
                if($data[$i]->from_template == 1) {
                  echo '<td><a href="manage?id='.escape($data[$i]->hb_account_id).'&virt=kvm" class="btn btn-sm btn-warning template_setup_btn">Setup</a></td>';
                }else{
                  echo '<td><a href="manage?id='.escape($data[$i]->hb_account_id).'&virt=kvm" class="btn btn-sm btn-info">Manage</a></td>';
                }
    					echo '</tr>';
                    }else{
