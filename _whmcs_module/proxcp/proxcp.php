...
function proxcp_ConfigOptions() {
  return [
    "servicetype" => [
      "FriendlyName" => "ProxCP Service Type",
      "Type" => "dropdown",
      "Options" => [
        'kvm' => 'KVM VPS',
        'pc' => 'KVM Public Cloud',
    ...
    "node" => [
      "FriendlyName" => "Proxmox Node",
      "Type" => "text",
      "Size" => "25",
      "Loader" => "proxcp_LoadNodeList",
      "SimpleMode" => true
    ],
    "storagesize" => [
    ...
    "nicdriver" => [
      "FriendlyName" => "NIC Driver",
      "Type" => "dropdown",
      "Options" => [
        "e1000" => "Intel E1000",
        "virtio" => "VirtIO"
      ],
      "Description" => "Only used for KVM products",
      "Default" => "ide",
      "SimpleMode" => true
    ],
    "cputype" => [
    ...
    "osinstalltype" => [
      "FriendlyName" => "Default OS Installation Type",
      "Type" => "dropdown",
      "Options" => [
        "iso" => "Manual ISO file",
    ...
    "iplimit" => [
      ...
      "Size" => "25",
      "SimpleMode" => true,
      "Description" => "How many IPs should be assigned to this cloud account? (KVM Cloud only)"
    ],
    "isnat" => [
      "FriendlyName" => "NAT VPS?",
      "Type" => "yesno",
      "Description" => "Tick to make this a NAT product",
      "SimpleMode" => true
    ],
    "natports" => [
      "FriendlyName" => "NAT Port Limit",
      "Type" => "text",
      "Size" => "25",
      "SimpleMode" => true,
      "Description" => "Number between 1 - 30. NAT products only"
    ],
    "natdomains" => [
      "FriendlyName" => "NAT Domain Limit",
      "Type" => "text",
      "Size" => "25",
      "SimpleMode" => true,
      "Description" => "Number between 0 - 15. NAT products only"
    ],
    "vlantag" => [
      ...
      "SimpleMode" => true,
      "Default" => "0",
      "Description" => "Add VLAN tag to VM NIC (1 - 4094). 0 = no tagging."
    ],
    "portspeed" => [
      "FriendlyName" => "Port Speed",
      "Type" => "text",
      "Size" => "25",
      "SimpleMode" => true,
      "Default" => "0",
      "Description" => "Add rate limit (MB/s) to VM NIC (1 - 10000). 0 = no limit."
    ],
    "backuplimit" => [
      ...
      "SimpleMode" => true,
      "Default" => "-1",
      "Description" => "Override default backup limit. -1 = use default."
    ]
  ];
}

function proxcp_LoadNodeList(array $params) {
...
function proxcp_CreateAccount(array $params) {
  try {
...
function proxcp_SuspendAccount(array $params) {
  try {
    $type = $params['configoption1'];
...
function proxcp_UnsuspendAccount(array $params) {
  try {
    $type = $params['configoption1'];
    $hbid = $params['serviceid'];
    $userid = $params['clientsdetails']['userid'];
...
function proxcp_TerminateAccount(array $params) {
  try {
    $type = $params['configoption1'];
    $hbid = $params['serviceid'];
    $userid = $params['clientsdetails']['userid'];
...
function proxcp_ClientArea(array $params) {
  $node = '';
  $ip = '';
  try {
    $type = $params['configoption1'];
