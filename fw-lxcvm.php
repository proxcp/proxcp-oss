      ...
      <div class="tabs">
       ...
       <div id="tab1" class="tab-single tab-cnt active">
            <div class="datacenters">
                <div class="col-md-12">
                    <?php
                    $options = $pxAPI->get('/nodes/'.$data->node.'/lxc/'.$vminfo['members'][0]['vmid'].'/firewall/options');
                    ?>
       ...
       <div id="tab2" class="tab-single tab-cnt">
             <div class="datacenters">
                <div class="col-md-12">
                    <?php
                    $rules = $pxAPI->get('/nodes/'.$data->node.'/lxc/'.$vminfo['members'][0]['vmid'].'/firewall/rules');
                    ?>
    ...
    <input type="submit" value="Save" class="btn btn-md btn-success" id="fwredit' . (string)$p . '" role="' . (string)$p . '" />
       ...
       <div id="tab4" class="tab-single tab-cnt">
             <div class="datacenters">
                <div class="col-md-12">
                    <?php
                    $log = $pxAPI->get('/nodes/'.$data->node.'/lxc/'.$vminfo['members'][0]['vmid'].'/firewall/log');
                    ?>
